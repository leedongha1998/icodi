...
/**
 * Servlet implementation class AdminRefundChanageServlet
 */
...
public class AdminOrderListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			List<MemberOrderProductManager> list = adminService.findAllOrderList(data); 
			
			int totalContent = adminService.getTotalContentAllOrderList();
