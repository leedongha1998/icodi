...
/**
 * Servlet implementation class HotCodiListServlet
 */
@WebServlet("/codi/hotCodiList")
public class HotCodiListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			request.getRequestDispatcher("/WEB-INF/views/codiBoard/hotCodiList.jsp").forward(request, response);
