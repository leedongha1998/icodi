...
public class IcodiMvcUtils {
	...
	public static String getPagebar(int cPage, int numPerPage, int totalContent, String url) {
		...
		int pagebarSize = 5;
		int pagebarStart = ((cPage - 1) / pagebarSize * pagebarSize) + 1; //1
		int pagebarEnd = pagebarStart + pagebarSize - 1; //5
